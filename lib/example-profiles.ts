...
export const exampleProfiles: ExampleProfile[] = [
  {
    ...
    profile: {
      ...
      // carousel shows faces rather than monograms. They sit on Nova, Rio and
      // Maya, but the pairing carries no meaning: these are stock portraits and
      // the example names are invented, so which face lands on which persona is
      // arbitrary. Initials stay as the fallback for the other three.
  ...
  },
  {
    ...
    profile: {
      ...
      socials: [
        { platform: "WhatsApp Business", url: "https://wa.me/15551234567" },
        { platform: "LinkedIn", url: "https://linkedin.com" },
