...
export async function generateMetadata({
  ...
  // Falls back to the per-profile card generated by opengraph-image.tsx rather
  // than the site-wide one, so a creator who never uploads an image still
  // unfurls with their own name, handle and colours instead of Cueful's.
  const socialImage =
    publicAssetUrl(profile?.seo_image_path) ??
    (profile
      ? `${BRAND_URL}/u/${username.toLowerCase()}/opengraph-image`
      : DEFAULT_SOCIAL_IMAGE);
